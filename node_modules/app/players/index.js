...
class Player {
    constructor(playerData) {
        ...
        this.weaponList = [weaponsModule.getDefaultWeapon()];
        this.hp = 100;
        ...
        this.lon = playerData.lon || playerData.country.latlng[1] + utils.random(5, -5);
        this.actionList = [];
    }
    ...
    addWeapon(weapon) {
        var weaponInList = this.getWeapon(weapon.name);
        if(weaponInList) {
            weaponInList.ammo += weapon.ammo;
        } else {
            this.weaponList.push(weapon);
        }
    }
    openBonusContainer() {
        this.addWeapon(weaponsModule.getBonusContainerRandomWeapon());
        this.bonusContainerVisible = false;
    }
}
...
module.exports = {
    ...
    getNoneCountry: function(country) {
        return {
            demonym: 'Unknown',
            latlon: [utils.random(65), utils.random(180)],
            name: {
                common: 'Unknown'
            }
        }
